...
API_ID = int(environ.get('API_ID', '27458014'))
API_HASH = environ.get('API_HASH', 'a9b2050ff58b8ad4a78858726a0dfcb2')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1368790090').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002403239964'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002406409711 -1002350362613').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Pcmovietolinkbot:Dhananjay042604@pcmovietolinkbot.lyvyx.mongodb.net/?retryWrites=true&w=majority&appName=Pcmovietolinkbot")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SHORTLINK_API = environ.get('SHORTLINK_API', '85425f2b89ef309ba8b4c392368075e7af963a4b')
